class ExerciciosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exercicio.save
        format.html { redirect_to @exercicio, notice: 'O Exercício foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @exercicio.update(exercicio_params)
        format.html { redirect_to @exercicio, notice: 'O Exercício foi atualizado com sucesso.' }
  ...
  def destroy
    @exercicio.destroy
    respond_to do |format|
      format.html { redirect_to exercicios_url, notice: 'O Exercício foi destruído com sucesso.' }
  ...
  private
    ...
    def exercicio_params
      params.require(:exercicio).permit(:nome)
    end
end
